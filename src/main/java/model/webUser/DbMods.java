...
public class DbMods {
    ...
    public static StringData delete(DbConn dbc, String userId) {
        ...
        try {
            ...
            if (numRowsDeleted == 0) {
                sd.errorMsg = "This record does not exist." + userId;
            ...
            if (msg.contains("foreign key")) {
                sd.errorMsg = "This user cannot be deleted because they have dog records associated with them.";
            } else {
                sd.errorMsg = "The database is currently unavailable. " + e.getMessage();
            }
        }        
