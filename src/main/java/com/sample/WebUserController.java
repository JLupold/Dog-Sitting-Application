...
public class WebUserController {
    ...
    @RequestMapping(value = "/webUser/logonAPI", params = { "email", "password" }, produces = "application/json")
    public String logonAPI(
        ...
        sd = WebUserView.findByEmailAndPassword(dbc, email, password);
    ...
    @RequestMapping(value = "/webUser/getProfileAPI", produces = "application/json")
    ...
    @RequestMapping(value = "/webUser/logoffAPI", produces = "application/json")
    ...
    @RequestMapping(value = "/webUser/delete", params = {
            "userId" }, produces = "application/json")
    public String getByIdToDelete(@RequestParam("userId") String deleteUserId) {
        StringData sd = new StringData();
